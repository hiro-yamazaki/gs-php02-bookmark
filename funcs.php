...
// 退会の扱い（論理削除）
//
// 退会するとまず deleted_at に日時が入るだけで、データは残る。
//   ・押し間違いで退会した人が、猶予期間内なら自分で元に戻せる
//   ・猶予期間を過ぎたら purge.php が個人情報ごと物理削除する
//
// 【重要】猶予期間は「復元できる利益」と「個人情報が残る不利益」の釣り合いで決めるもの。
// 長くすれば安全というものではない。プライバシーポリシーに書く日数と必ず一致させること。
// ======================================================

const WITHDRAW_GRACE_DAYS = 30; //退会後、復元できる日数
